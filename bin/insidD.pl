...
print M "end;\n";
print M "Begin paup;\n";
print M "UPGMA brlens=yes;\n";
print M "savetree brlens=yes file=$outdir/upgma.tree;\n";
print M "NJ brlens=yes;\n";
print M "savetree brlens=yes file=$outdir/nj.tree;\n";
print M "end;\n";
